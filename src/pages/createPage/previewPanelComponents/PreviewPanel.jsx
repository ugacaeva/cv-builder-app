...
export default function PreviewPanel({ expanded = false }) {
    ...
    return (
        <div className="bg-white rounded-lg shadow p-4 sm:p-6 min-h-[70vh] overflow-auto">
        <h2 className="text-lg sm:text-xl font-semibold mb-4">Превью</h2>

        <div id="resume-preview" className="border border-gray-100 rounded p-4 sm:p-6 min-h-[40vh]">
