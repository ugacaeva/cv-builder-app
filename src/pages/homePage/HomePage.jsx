            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
                <div>
                    ...
                    <div className="mt-8 flex flex-wrap gap-3">
                        ...
                        className="px-6 py-3 bg-indigo-600 text-white rounded-md text-sm font-semibold shadow hover:bg-indigo-500"
                        >
                            Создать резюме
                        </button>
                ...
                <div className="bg-white rounded-lg shadow p-6">
                    ...
                    <div className="text-center">
                        <p className="mt-2 text-sm text-gray-500">Здесь будут Превью Шаблонов, если Господь будет милостив</p>
                    </div>
                    </div>
